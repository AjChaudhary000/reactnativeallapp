...
class ShopOrderList extends Component {
  ...
  orderDetail = (item) => {
    this.props.navigation.navigate('ShopOrderDetail', {data: item});
  };
  get_complete_orders = () => {
    this.props.navigation.navigate('ShopCompleteOrderList', {shop_id: shop_id});
  };
  render() {
    ...
    return (
      <View style={styles.MainContainer}>
        ...
        <View style={{flexDirection: 'row'}}>
          <View style={{width: '15%'}} />
          <Text style={styles.order_title}>ORDERS</Text>
          <TouchableOpacity
            onPress={() => this.get_complete_orders()}
            style={{width: '15%'}}>
            <Image
...
export default connect(mapStateToProps, mapDispatchToProps)(ShopOrderList);
